<div class="df fdc">
			...
			<div class="mobile_top_menu_items df fg-20">
				<div class="mobil_top_item">
					<a class="secondary-link" href="?page=notifications">
						<i class="medium_icon fi fi-sr-bell"></i>
					</a>
				</div>
				<div class="mobil_top_item">
					<a class="secondary-link" href="?page=messages">
						<i class="medium_icon fi fi-sr-envelope"></i>
					</a>
				</div>
				<div class="mobil_top_item">
	...
	<div class="mobile_info_header">
		<div class="df jcsb">
			<div class="secondary-link df aic fdc fg-3">
				<i class="semi_medium_icon text-orange fi fi-sr-user"></i>
				<div>Gudfar • 71%</div>
			...
			<div class="secondary-link df aic fdc fg-3">
				<i class="semi_medium_icon text-green fi fi-sr-heart"></i>
				<div>Helse • 100%</div>
			...
			<div class="secondary-link df aic fdc fg-3">
				<i class="semi_medium_icon fi fi-sr-shield-check"></i>
				<div>Ekstra beskyttelse</div>
				<div class="text-secondary">Gå i safehouse</div>
			</div>
			<div class="secondary-link df aic fdc fg-3">
				<i class="semi_medium_icon text-blue fi fi-ss-code-branch"></i>
				<div>CobrazArme</div>
				<div class="text-secondary">Gjengboss</div>
			</div>
			<div class="secondary-link df aic fdc fg-3">
				<i class="semi_medium_icon text-red fi fi-rr-marker"></i>
				<div>Norge</div>
	...
	<div class="mobile_navigation_header">
		...
		<div class="mobile-nav-item df fg-5 shadow">
			<i class="text-orange fi fi-sr-flame"></i>
			14,2k kuler
		</div>
		<div class="mobile-nav-item df fg-5 shadow">
			<i class="text-light-blue fi fi-rr-diamond"></i>
			260 poeng
		</div>
